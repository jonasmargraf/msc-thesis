...
\subsubsection{Learning Rate Factor Comparison}
...
\begin{figure}[!htb]
  ...
  % }
  \caption[Comparison of \gls{som} learning rate factors]
...
\paragraph{BDH: Effect of Magnification Control $m$}
...
\textit{Drum Essentials} sample library. The blue mark denotes the same file in
both maps.
\gls{som} parameters: $\texttt{mapSize} = 32\times32$,
training duration $ = 10^4$ steps,
$\alpha_{initial} = 0.9$,
