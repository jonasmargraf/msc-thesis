...
entry point: \texttt{main.js} > \texttt{index.js} > \texttt{components/App.js}
> \texttt{background.js} > \texttt{extractFeatures.js}
> \texttt{som.js} > \texttt{calculateSOM.js}
...
\mintinline{js}{processFiles(files)}
\mintinline{js}{createSOM(files, settings)}
