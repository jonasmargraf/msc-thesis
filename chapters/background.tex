...
introduced in 1981 by Teuvo Kohonen \citep{kohonen1990}. The \gls{som} is a
...
onto a regular, often two-dimensional grid or \textit{map} that is easy to
visualize. It can be regarded as a nonlinear generalization of a principal
component analysis (PCA) \citep{yin2007}. For an in-depth look at the algorithm,
its variants and applications, as well as an extensive survey of research on
\glspl{som}, the avid reader is referred to \citet{kohonen2001}.
